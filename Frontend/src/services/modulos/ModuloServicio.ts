...
export class ModuloServicio {
    ...
    async obtenerModulos (){
        try {
            ...
            const equiposBackend = response.data;
            // return equiposBackend.map((equipo)=>new equiposEntity(equipo))
